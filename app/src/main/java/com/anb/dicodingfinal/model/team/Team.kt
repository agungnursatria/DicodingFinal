...
data class Team(
    ...
    companion object {
        ...
        const val FORMED_YEARS = "FORMED_YEARS"
        ...
        const val STADIUM_DESC = "STADIUM_DESC"
        const val STADIUM_LOC = "STADIUM_LOC"
        const val STADIUM_CAPACITY = "STADIUM_CAPACITY"
        const val WEBSITE = "WEBSITE"
        const val FACEBOOK = "FACEBOOK"
        const val TWITTER = "TWITTER"
        const val INSTAGRAM = "INSTAGRAM"
        const val DESCRIPTIONEN = "DESCRIPTIONEN"
        const val DESCRIPTIONDE = "DESCRIPTIONDE"
        const val DESCRIPTIONFR = "DESCRIPTIONFR"
        const val DESCRIPTIONCN = "DESCRIPTIONCN"
        const val DESCRIPTIONIT = "DESCRIPTIONIT"
        const val DESCRIPTIONJP = "DESCRIPTIONJP"
        const val DESCRIPTIONRU = "DESCRIPTIONRU"
        const val DESCRIPTIONES = "DESCRIPTIONES"
        const val DESCRIPTIONPT = "DESCRIPTIONPT"
        const val DESCRIPTIONSE = "DESCRIPTIONSE"
        const val DESCRIPTIONNL = "DESCRIPTIONNL"
        const val DESCRIPTIONHU = "DESCRIPTIONHU"
        const val DESCRIPTIONNO = "DESCRIPTIONNO"
        const val DESCRIPTIONIL = "DESCRIPTIONIL"
        const val DESCRIPTIONPL = "DESCRIPTIONPL"
        const val GENDER = "GENDER"
        const val COUNTRY = "COUNTRY"
        const val TEAM_BADGE = "TEAM_BADGE"
        const val JERSEY = "JERSEY"
        const val LOGO = "LOGO"
        const val TEAM_FANART1 = "TEAM_FANART1"
        const val TEAM_FANART2 = "TEAM_FANART2"
        const val TEAM_FANART3 = "TEAM_FANART3"
        const val TEAM_FANART4 = "TEAM_FANART4"
